...
**DEPRECATED**: Use `/wallet/collect` instead.
...
* All card fields are optional - submit only available data
...
[Set payment method as default](/api-reference/v2/payment-methods/set-payment-method-as-default)[Collect customer information](/api-reference/v2/collect/collect-customer-information)
