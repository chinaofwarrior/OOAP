...
Create or update the customer’s shipping address. Each user (x-user-id) can have only one shipping address. If a shipping address already exists for this user, it will be updated. If it doesn’t exist, it will be created.
