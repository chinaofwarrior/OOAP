...
[Get All Mandates](/api-reference/v2/mandates/get-all-mandates)[Execute Visa Payment Instruction Action](/api-reference/v2/mandates/execute-visa-payment-instruction-action)
