...
Returns default card if available, otherwise most recent active card.
...
**Use Case:** Get the most relevant stored card for a user (default or most recent)
...
[Get Default Card](/api-reference/v2/cards/get-default-card)[Get Card by ID](/api-reference/v2/cards/get-card-by-id)
