...
**Use Case:** Remove payment method from user’s wallet
...
[Get Card by ID](/api-reference/v2/cards/get-card-by-id)[Update Card Information](/api-reference/v2/cards/update-card-information)
