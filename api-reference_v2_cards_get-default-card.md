...
Retrieve the default card for a user.
...
**Use Case:** Get the user’s default card for payment processing
...
[Get All Cards](/api-reference/v2/cards/get-all-cards)[Get Stored Card Details](/api-reference/v2/cards/get-stored-card-details)
