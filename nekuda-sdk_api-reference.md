...
* [Key Exception Classes](#key-exception-classes)
* [Common Exception Attributes](#common-exception-attributes)
* [Usage Examples](#usage-examples)
* [Complete Payment Flow (using UserContext - Recommended)](#complete-payment-flow-using-usercontext-recommended)
* [Global Default Client Pattern](#global-default-client-pattern)
...
Refer to the [Error Handling guide](/nekuda-sdk/Errors) for a detailed hierarchy and usage patterns.
