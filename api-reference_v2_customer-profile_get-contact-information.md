...
Retrieve the customer’s contact information. Each user (x-user-id) has a single contact information record.
...
[Collect customer information](/api-reference/v2/collect/collect-customer-information)[Update Contact Information](/api-reference/v2/customer-profile/update-contact-information)
