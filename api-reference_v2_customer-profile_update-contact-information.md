...
Create or update the customer’s contact information. Each user (x-user-id) can have only one contact record. If contact information already exists for this user, it will be updated. If it doesn’t exist, it will be created.
...
[Get Contact Information](/api-reference/v2/customer-profile/get-contact-information)[Get Shipping Address](/api-reference/v2/customer-profile/get-shipping-address)
