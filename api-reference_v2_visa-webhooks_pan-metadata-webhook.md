...
Handle Visa PAN metadata webhook.

This endpoint receives PAN (Primary Account Number) metadata from Visa.
...
[Provisioned Token Webhook](/api-reference/v2/visa-webhooks/provisioned-token-webhook)[Request Card Reveal Token](/api-reference/v2/card-reveal/request-card-reveal-token)
