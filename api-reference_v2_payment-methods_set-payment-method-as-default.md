...
```
curl --request POST \
  --url https://api.example.com/api/v2/wallet/payment-methods/{paymentMethodId}/set-default \
...
[Update payment method CVV](/api-reference/v2/payment-methods/update-payment-method-cvv)[Collect Card Details (Legacy)](/api-reference/v2/collect/collect-card-details-legacy)
