...
Retrieve the customer’s shipping address. Each user (x-user-id) has a single shipping address record.
...
[Update Contact Information](/api-reference/v2/customer-profile/update-contact-information)[Update Shipping Address](/api-reference/v2/customer-profile/update-shipping-address)
